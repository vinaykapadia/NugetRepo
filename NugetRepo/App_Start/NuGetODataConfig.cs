...
using NugetRepo.App_Start;

[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(NuGetODataConfig), nameof(NuGetODataConfig.Start))]

namespace NugetRepo.App_Start 
{
    public static class NuGetODataConfig 
    {
        public static void Start() 
        {
            ...
            config.UseNuGetV2WebApiFeed("NuGetDefault",
                "nuget",
                "PackagesOData",
